...
const List = () => {
    ...
    const handleSubmit = async(e) =>{
        try{
            e.preventDefault();
            await firebase.handleCreateNewListing(name,owner,isbn,price,cover);
  ...
  return (
    <div className="w-[700px] mx-auto mt-[150px]">
        <h1 className="text-[40px] font-bold">Add Items</h1>
        ...
        <div className="relative z-0 w-full mb-6 group">
            <input onChange={(e) => setOwner(e.target.value)} 
                value={owner}
            type="text"  id="floating_password" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none  dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
        ...
        <div className="relative z-0 w-full mb-6 group text-black">
            <input onChange={(e) => setIsbn(e.target.value)}
                value={isbn}
            type="text"  id="floating_repeat_password" className="  block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
        ...
        <div className="grid md:grid-cols-2 md:gap-6">
            <div className="relative z-0 w-full mb-6 group">
                <input onChange={(e) => setPrice(e.target.value)}
                    value={price}
                type="text" id="floating_first_name" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none  dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
