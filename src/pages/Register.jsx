...
const Register = () => {
  ...
  return (
    <div className="w-[500px] mx-auto mt-[100px]">
        ...
        <h1 className="text-white mx-auto mb-5 font-semibold text-[50px]" >Register</h1>
        <div className="mb-6">
        ...
        <div className="mb-6">
                <p className="text-white text-sm">Already have an account? <Link to="/login"><span className="font-bold">login</span></Link> </p>
            </div>
